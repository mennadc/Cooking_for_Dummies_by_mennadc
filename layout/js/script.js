window.addEventListener('load', () => {
    ...
    // Get scroll to top arrow button
    var scrollToTopBtn = document.querySelector('.scrollToTopBtn');    

    /* Showing scroll button handler */
    ...
    // Counter of added elements in writing and searching recipe page
    var i = 0;
    /* Adding an ingredient input in writing recipe page */
    ...
    /* Adding an ingredient input in searching recipe page */
    ...
    /* Removing an element in writing and searching recipe page */
    $(document).on('click', '.btn_remove', function () {
        var button_id = $(this).attr('id');
        $('#row' + button_id + '').remove();
    });

    /* Submit button of writing recipe page */
    $('#submit').click(() => {
        $.ajax({
    ...
    /* Displaying notifications menu on click handler */
